...
import uk.ac.abertay.cmp309.project_weather.databinding.NewAppWidgetConfigureBinding;
...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "uk.ac.abertay.cmp309.project_weather.NewAppWidget";
